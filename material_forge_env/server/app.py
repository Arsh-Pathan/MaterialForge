...
"""
FastAPI application for the Material Forge Env Environment.

This module creates an HTTP server that exposes the MaterialForgeEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m material_forge_env.server.app
    ...
    multiple workers:
        uvicorn material_forge_env.server.app:app --workers 4
    """
    import uvicorn
